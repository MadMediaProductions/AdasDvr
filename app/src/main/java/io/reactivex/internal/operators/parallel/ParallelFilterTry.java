...
public final class ParallelFilterTry<T> extends ParallelFlowable<T> {
    ...
    static final class ParallelFilterSubscriber<T> extends BaseFilterSubscriber<T> {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:3:0x0008 A[LOOP:0: B:3:0x0008->B:12:0x0037, LOOP_START, PHI: r4 
          PHI: (r4v1 'retries' long) = (r4v0 'retries' long), (r4v2 'retries' long) binds: [B:2:0x0006, B:12:0x0037] A[DONT_GENERATE, DONT_INLINE], SYNTHETIC, Splitter:B:3:0x0008] */
        ...
        public boolean tryOnNext(T r13) {
            ...
            L_0x0016:
                ...
                io.reactivex.functions.BiFunction r8 = r12.errorHandler     // Catch:{ Throwable -> 0x0042 }
                r10 = 1
                long r4 = r4 + r10
                java.lang.Long r9 = java.lang.Long.valueOf(r4)     // Catch:{ Throwable -> 0x0042 }
                java.lang.Object r8 = r8.apply(r9, r1)     // Catch:{ Throwable -> 0x0042 }
                java.lang.String r9 = "The errorHandler returned a null item"
                java.lang.Object r3 = io.reactivex.internal.functions.ObjectHelper.requireNonNull(r8, r9)     // Catch:{ Throwable -> 0x0042 }
                io.reactivex.parallel.ParallelFailureHandling r3 = (io.reactivex.parallel.ParallelFailureHandling) r3     // Catch:{ Throwable -> 0x0042 }
    ...
    static final class ParallelFilterConditionalSubscriber<T> extends BaseFilterSubscriber<T> {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:3:0x0008 A[LOOP:0: B:3:0x0008->B:14:0x003b, LOOP_START, PHI: r4 
          PHI: (r4v1 'retries' long) = (r4v0 'retries' long), (r4v2 'retries' long) binds: [B:2:0x0006, B:14:0x003b] A[DONT_GENERATE, DONT_INLINE], SYNTHETIC, Splitter:B:3:0x0008] */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public boolean tryOnNext(T r13) {
            /*
                r12 = this;
            ...
            L_0x001a:
                r1 = move-exception
                io.reactivex.exceptions.Exceptions.throwIfFatal(r1)
                io.reactivex.functions.BiFunction r8 = r12.errorHandler     // Catch:{ Throwable -> 0x0045 }
                r10 = 1
                long r4 = r4 + r10
                java.lang.Long r9 = java.lang.Long.valueOf(r4)     // Catch:{ Throwable -> 0x0045 }
                java.lang.Object r8 = r8.apply(r9, r1)     // Catch:{ Throwable -> 0x0045 }
                java.lang.String r9 = "The errorHandler returned a null item"
                java.lang.Object r3 = io.reactivex.internal.functions.ObjectHelper.requireNonNull(r8, r9)     // Catch:{ Throwable -> 0x0045 }
                io.reactivex.parallel.ParallelFailureHandling r3 = (io.reactivex.parallel.ParallelFailureHandling) r3     // Catch:{ Throwable -> 0x0045 }
                int[] r8 = io.reactivex.internal.operators.parallel.ParallelFilterTry.AnonymousClass1.$SwitchMap$io$reactivex$parallel$ParallelFailureHandling
                int r9 = r3.ordinal()
                r8 = r8[r9]
                switch(r8) {
