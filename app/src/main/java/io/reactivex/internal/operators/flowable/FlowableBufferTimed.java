...
public final class FlowableBufferTimed<T, U extends Collection<? super T>> extends AbstractFlowableWithUpstream<T, U> {
    ...
    static final class BufferExactUnboundedSubscriber<T, U extends Collection<? super T>> extends QueueDrainSubscriber<T, U, U> implements Subscription, Runnable, Disposable {
        ...
        public void onComplete() {
            /*
                r4 = this;
                java.util.concurrent.atomic.AtomicReference<io.reactivex.disposables.Disposable> r1 = r4.timer
    ...
    static final class BufferExactBoundedSubscriber<T, U extends Collection<? super T>> extends QueueDrainSubscriber<T, U, U> implements Subscription, Runnable, Disposable {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:22:0x0041, code lost:
            if (r11.restartTimerOnMaxSize == false) goto L_0x006c;
         */
        ...
        public void onNext(T r12) {
            ...
            L_0x002b:
                ...
                java.util.concurrent.Callable<U> r2 = r11.bufferSupplier     // Catch:{ Throwable -> 0x005c }
                java.lang.Object r2 = r2.call()     // Catch:{ Throwable -> 0x005c }
                java.lang.String r3 = "The supplied buffer is null"
                java.lang.Object r2 = io.reactivex.internal.functions.ObjectHelper.requireNonNull(r2, r3)     // Catch:{ Throwable -> 0x005c }
                r0 = r2
                java.util.Collection r0 = (java.util.Collection) r0     // Catch:{ Throwable -> 0x005c }
                r9 = r0
                boolean r2 = r11.restartTimerOnMaxSize
                if (r2 == 0) goto L_0x006c
                monitor-enter(r11)
                r11.buffer = r9     // Catch:{ all -> 0x0069 }
                long r2 = r11.consumerIndex     // Catch:{ all -> 0x0069 }
                long r2 = r2 + r4
            ...
            L_0x006c:
                monitor-enter(r11)
                r11.buffer = r9     // Catch:{ all -> 0x0071 }
        ...
        public void run() {
            /*
                r8 = this;
                java.util.concurrent.Callable<U> r3 = r8.bufferSupplier     // Catch:{ Throwable -> 0x001d }
                java.lang.Object r3 = r3.call()     // Catch:{ Throwable -> 0x001d }
                java.lang.String r4 = "The supplied buffer is null"
                java.lang.Object r2 = io.reactivex.internal.functions.ObjectHelper.requireNonNull(r3, r4)     // Catch:{ Throwable -> 0x001d }
                java.util.Collection r2 = (java.util.Collection) r2     // Catch:{ Throwable -> 0x001d }
                monitor-enter(r8)
                U r0 = r8.buffer     // Catch:{ all -> 0x0032 }
                if (r0 == 0) goto L_0x001b
                long r4 = r8.producerIndex     // Catch:{ all -> 0x0032 }
                long r6 = r8.consumerIndex     // Catch:{ all -> 0x0032 }
