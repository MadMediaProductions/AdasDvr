...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    public static VectorDrawableCompat create(@NonNull Resources r8, @android.support.annotation.DrawableRes int r9, @android.support.annotation.Nullable Resources.Theme r10) {
        /*
            r7 = 2
