...
public abstract class Flowable<T> implements Publisher<T> {
    ...
    public static <T, R> Flowable<R> zip(Publisher<? extends Publisher<? extends T>> r2, Function<? super Object[], ? extends R> r3) {
        /*
    ...
    public final Flowable<List<T>> buffer(long timespan, TimeUnit unit, Scheduler scheduler) {
        return buffer(timespan, unit, scheduler, ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, ArrayListSupplier.asCallable(), false);
    }
    ...
    @SchedulerSupport("none")
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final <U, V> Flowable<T> delay(Publisher<U> r2, Function<? super T, ? extends Publisher<V>> r3) {
        /*
            r1 = this;
