...
class NotificationCompatJellybean {
    ...
    public static NotificationCompatBase.Action getAction(Notification r12, int r13, NotificationCompatBase.Action.Factory r14, RemoteInputCompatBase.RemoteInput.Factory r15) {
        /*
