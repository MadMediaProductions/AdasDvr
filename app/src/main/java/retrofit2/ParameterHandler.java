    ...
    static final class PartMap<T> extends ParameterHandler<Map<String, T>> {
        ...
        public void apply(RequestBuilder builder, @Nullable Map<String, T> value) throws IOException {
            ...
            for (Map.Entry<String, T> entry : value.entrySet()) {
                ...
                builder.addPart(Headers.of("Content-Disposition", "form-data; name=\"" + entryKey + "\"", MIME.CONTENT_TRANSFER_ENC, this.transferEncoding), this.valueConverter.convert(entryValue));
            }
        }
    }
