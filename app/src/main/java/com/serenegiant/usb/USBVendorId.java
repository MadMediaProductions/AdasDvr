...
public class USBVendorId {
    ...
    static {
        IDS.put(Highgui.CV_CAP_PROP_GIGA_FRAME_SENS_HEIGH, "YUEN DA ELECTRONIC PRODUCTS FACTORY");
        ...
        IDS.put(Highgui.CV_CAP_PROP_PREVIEW_FORMAT, "ALi Corporation");
        ...
        IDS.put(Highgui.CV_CAP_PROP_INTELPERC_PROFILE_COUNT, "Drapho Electronics Technology Co., Ltd.");
        ...
        IDS.put(Highgui.CV_CAP_AVFOUNDATION, "Nikon Corporation");
        ...
        IDS.put(Highgui.CV_CAP_GIGANETIX, "FCI Electronics");
        ...
        IDS.put(GetPicUtil.MSG_GET_PIC_TIME_STRING_IS_NULL, "Casio Computer Co., Ltd.");
        ...
        IDS.put(FeatureDetector.DYNAMIC_DENSE, "Seagate Technology LLC");
    ...
    public static String vendorName(int vendor_id) {
