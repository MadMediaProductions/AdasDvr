...
public final class b {
    ...
    protected static String a(String str) {
        ...
        String[] split = str.split(DoCmdUtil.COMMAND_LINE_END);
        ...
        for (String str2 : split) {
            if (!str2.contains("java.lang.Thread.getStackTrace(")) {
                sb.append(str2).append(DoCmdUtil.COMMAND_LINE_END);
            }
        }
        return sb.toString();
    }
    ...
    private static CrashDetailBean a(Context context, Map<String, String> map, NativeExceptionHandler nativeExceptionHandler) {
        ...
        try {
            ...
            if (str21 != null) {
                hashMap = new HashMap();
                for (String split : str21.split(DoCmdUtil.COMMAND_LINE_END)) {
    ...
    private static String a(java.io.BufferedInputStream r5) throws java.io.IOException {
        /*
            r0 = 0
        ...
        L_0x0028:
            r1 = move-exception
        L_0x0029:
            com.tencent.bugly.proguard.x.a(r1)     // Catch:{ all -> 0x003f }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static CrashDetailBean a(Context r6, String r7, NativeExceptionHandler r8) {
        /*
            r2 = 0
            r0 = 0
            ...
            while (true) {
                try {
                    ...
                    if (Pattern.compile(str2 + "[ ]*:").matcher(readLine).find()) {
                        sb.append(readLine).append(DoCmdUtil.COMMAND_LINE_END);
                    }
                    if (i > 0 && sb.length() > i) {
                        if (z) {
