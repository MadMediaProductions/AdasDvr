...
public final class ParallelMapTry<T, R> extends ParallelFlowable<R> {
    ...
    static final class ParallelMapTrySubscriber<T, R> implements ConditionalSubscriber<T>, Subscription {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:3:0x0009 A[LOOP:0: B:3:0x0009->B:11:0x003d, LOOP_START, PHI: r4 
          PHI: (r4v1 'retries' long) = (r4v0 'retries' long), (r4v2 'retries' long) binds: [B:2:0x0007, B:11:0x003d] A[DONT_GENERATE, DONT_INLINE], SYNTHETIC, Splitter:B:3:0x0009] */
        ...
        public boolean tryOnNext(T r13) {
            ...
            L_0x0007:
                r4 = 0
            L_0x0009:
                io.reactivex.functions.Function<? super T, ? extends R> r8 = r12.mapper     // Catch:{ Throwable -> 0x001c }
                java.lang.Object r8 = r8.apply(r13)     // Catch:{ Throwable -> 0x001c }
                java.lang.String r9 = "The mapper returned a null value"
                java.lang.Object r3 = io.reactivex.internal.functions.ObjectHelper.requireNonNull(r8, r9)     // Catch:{ Throwable -> 0x001c }
            ...
            L_0x001c:
                ...
                io.reactivex.functions.BiFunction<? super java.lang.Long, ? super java.lang.Throwable, io.reactivex.parallel.ParallelFailureHandling> r8 = r12.errorHandler     // Catch:{ Throwable -> 0x0047 }
                r10 = 1
                long r4 = r4 + r10
                java.lang.Long r9 = java.lang.Long.valueOf(r4)     // Catch:{ Throwable -> 0x0047 }
                java.lang.Object r8 = r8.apply(r9, r0)     // Catch:{ Throwable -> 0x0047 }
                java.lang.String r9 = "The errorHandler returned a null item"
                java.lang.Object r2 = io.reactivex.internal.functions.ObjectHelper.requireNonNull(r8, r9)     // Catch:{ Throwable -> 0x0047 }
                io.reactivex.parallel.ParallelFailureHandling r2 = (io.reactivex.parallel.ParallelFailureHandling) r2     // Catch:{ Throwable -> 0x0047 }
    ...
    static final class ParallelMapTryConditionalSubscriber<T, R> implements ConditionalSubscriber<T>, Subscription {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:3:0x0008 A[LOOP:0: B:3:0x0008->B:11:0x003c, LOOP_START, PHI: r4 
          PHI: (r4v1 'retries' long) = (r4v0 'retries' long), (r4v2 'retries' long) binds: [B:2:0x0006, B:11:0x003c] A[DONT_GENERATE, DONT_INLINE], SYNTHETIC, Splitter:B:3:0x0008] */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public boolean tryOnNext(T r11) {
            ...
            L_0x0006:
                r4 = 0
            L_0x0008:
                io.reactivex.functions.Function<? super T, ? extends R> r7 = r10.mapper     // Catch:{ Throwable -> 0x001b }
                java.lang.Object r7 = r7.apply(r11)     // Catch:{ Throwable -> 0x001b }
                java.lang.String r8 = "The mapper returned a null value"
                java.lang.Object r3 = io.reactivex.internal.functions.ObjectHelper.requireNonNull(r7, r8)     // Catch:{ Throwable -> 0x001b }
            ...
            L_0x001b:
                r0 = move-exception
                io.reactivex.exceptions.Exceptions.throwIfFatal(r0)
                io.reactivex.functions.BiFunction<? super java.lang.Long, ? super java.lang.Throwable, io.reactivex.parallel.ParallelFailureHandling> r7 = r10.errorHandler     // Catch:{ Throwable -> 0x0046 }
                r8 = 1
                long r4 = r4 + r8
                java.lang.Long r8 = java.lang.Long.valueOf(r4)     // Catch:{ Throwable -> 0x0046 }
                java.lang.Object r7 = r7.apply(r8, r0)     // Catch:{ Throwable -> 0x0046 }
                java.lang.String r8 = "The errorHandler returned a null item"
                java.lang.Object r2 = io.reactivex.internal.functions.ObjectHelper.requireNonNull(r7, r8)     // Catch:{ Throwable -> 0x0046 }
                io.reactivex.parallel.ParallelFailureHandling r2 = (io.reactivex.parallel.ParallelFailureHandling) r2     // Catch:{ Throwable -> 0x0046 }
