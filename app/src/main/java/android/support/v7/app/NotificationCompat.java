...
public class NotificationCompat extends android.support.v4.app.NotificationCompat {
    ...
    @TargetApi(24)
    @RequiresApi(24)
    public static void addStyleToBuilderApi24(NotificationBuilderWithBuilderAccessor builder, Builder b) {
    ...
    @TargetApi(21)
    @RequiresApi(21)
    public static RemoteViews addStyleGetContentViewLollipop(NotificationBuilderWithBuilderAccessor builder, Builder b) {
    ...
    @TargetApi(16)
    @RequiresApi(16)
    public static RemoteViews addStyleGetContentViewJellybean(NotificationBuilderWithBuilderAccessor builder, Builder b) {
    ...
    /* access modifiers changed from: private */
    public static MessagingStyle.Message findLatestIncomingMessage(MessagingStyle style) {
    ...
    /* access modifiers changed from: private */
    public static CharSequence makeMessageLine(Builder b, MessagingStyle style, MessagingStyle.Message m) {
    ...
    private static void addMessagingFallBackStyle(MessagingStyle style, NotificationBuilderWithBuilderAccessor builder, Builder b) {
        ...
        for (int i = messages.size() - 1; i >= 0; i--) {
            ...
            if (i != messages.size() - 1) {
                completeMessage.insert(0, DoCmdUtil.COMMAND_LINE_END);
            }
    ...
    private static boolean hasMessagesWithoutSender(List<MessagingStyle.Message> messages) {
        for (int i = messages.size() - 1; i >= 0; i--) {
    ...
    @TargetApi(14)
    @RequiresApi(14)
    public static RemoteViews addStyleGetContentViewIcs(NotificationBuilderWithBuilderAccessor builder, Builder b) {
        if (b.mStyle instanceof MediaStyle) {
            MediaStyle mediaStyle = (MediaStyle) b.mStyle;
    ...
    @TargetApi(16)
    @RequiresApi(16)
    public static void addBigStyleToBuilderJellybean(Notification n, Builder b) {
    ...
    @TargetApi(21)
    @RequiresApi(21)
    public static void addBigStyleToBuilderLollipop(Notification n, Builder b) {
        RemoteViews innerView;
        if (b.getBigContentView() != null) {
            innerView = b.getBigContentView();
        } else {
    ...
    @TargetApi(21)
    @RequiresApi(21)
    public static void addHeadsUpToBuilderLollipop(Notification n, Builder b) {
        RemoteViews innerView;
    ...
    public static class Builder extends Builder {
        ...
        public CharSequence resolveText() {
            if (this.mStyle instanceof MessagingStyle) {
                ...
                MessagingStyle.Message m = NotificationCompat.findLatestIncomingMessage(style);
