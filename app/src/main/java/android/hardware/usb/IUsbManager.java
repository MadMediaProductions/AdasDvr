...
public interface IUsbManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IUsbManager {
        ...
        static final int TRANSACTION_setPortRoles = 21;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    Bundle _arg012 = new Bundle();
                    getDeviceList(_arg012);
                    reply.writeNoException();
                    if (_arg012 != null) {
                        reply.writeInt(1);
                        _arg012.writeToParcel(reply, 1);
                        return true;
                    }
                    reply.writeInt(0);
                    return true;
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                    ParcelFileDescriptor _result = openDevice(data.readString());
                    reply.writeNoException();
                    if (_result != null) {
                        reply.writeInt(1);
                ...
                case 4:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg011 = (UsbAccessory) UsbAccessory.CREATOR.createFromParcel(data);
                    } else {
                        _arg011 = null;
                    }
                    ParcelFileDescriptor _result3 = openAccessory(_arg011);
                    reply.writeNoException();
                    if (_result3 != null) {
                        reply.writeInt(1);
                ...
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg010 = (UsbDevice) UsbDevice.CREATOR.createFromParcel(data);
                    } else {
                        _arg010 = null;
                    }
                    setDevicePackage(_arg010, data.readString(), data.readInt());
                    reply.writeNoException();
                    return true;
                case 6:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg09 = (UsbAccessory) UsbAccessory.CREATOR.createFromParcel(data);
                    } else {
                        _arg09 = null;
                    }
                    setAccessoryPackage(_arg09, data.readString(), data.readInt());
                    reply.writeNoException();
                    return true;
                case 7:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg08 = (UsbDevice) UsbDevice.CREATOR.createFromParcel(data);
                    } else {
                        _arg08 = null;
                    }
                    boolean _result4 = hasDevicePermission(_arg08);
                    reply.writeNoException();
                    if (_result4) {
                        i = 1;
                    }
                ...
                case 8:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg07 = (UsbAccessory) UsbAccessory.CREATOR.createFromParcel(data);
                    } else {
                        _arg07 = null;
                    }
                    boolean _result5 = hasAccessoryPermission(_arg07);
                    reply.writeNoException();
                    if (_result5) {
                        i = 1;
                    }
                ...
                case 9:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg06 = (UsbDevice) UsbDevice.CREATOR.createFromParcel(data);
                    } else {
                        _arg06 = null;
                    }
                    ...
                    requestDevicePermission(_arg06, _arg1, _arg22);
                    reply.writeNoException();
                    return true;
                case 10:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg05 = (UsbAccessory) UsbAccessory.CREATOR.createFromParcel(data);
                    } else {
                        _arg05 = null;
                    }
                    ...
                    requestAccessoryPermission(_arg05, _arg12, _arg2);
                    reply.writeNoException();
                    return true;
                case 11:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg04 = (UsbDevice) UsbDevice.CREATOR.createFromParcel(data);
                    } else {
                        _arg04 = null;
                    }
                    grantDevicePermission(_arg04, data.readInt());
                    reply.writeNoException();
                    return true;
                case 12:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg03 = (UsbAccessory) UsbAccessory.CREATOR.createFromParcel(data);
                    } else {
                        _arg03 = null;
                    }
                    grantAccessoryPermission(_arg03, data.readInt());
                    reply.writeNoException();
                    return true;
                case 13:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _result6 = hasDefaults(data.readString(), data.readInt());
                    reply.writeNoException();
                    if (_result6) {
                        i = 1;
                    }
                ...
                case 15:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _result7 = isFunctionEnabled(data.readString());
                    reply.writeNoException();
                    if (_result7) {
                        i = 1;
                    }
