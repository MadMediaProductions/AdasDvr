    ...
    public void measure() {
        ...
        if (this.mFramesCouner % 20 == 0) {
            ...
            if (this.mWidth == 0 || this.mHeight == 0) {
                this.mStrfps = String.valueOf(FPS_FORMAT.format(fps)) + " FPS";
            } else {
                this.mStrfps = String.valueOf(FPS_FORMAT.format(fps)) + " FPS@" + Integer.valueOf(this.mWidth) + "x" + Integer.valueOf(this.mHeight);
            }
