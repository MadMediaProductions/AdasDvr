...
final class Http2Reader implements Closeable {
    ...
    private void readPriority(Handler handler, int streamId) throws IOException {
        ...
        handler.priority(streamId, w1 & ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, (this.source.readByte() & 255) + 1, (Integer.MIN_VALUE & w1) != 0);
    }
