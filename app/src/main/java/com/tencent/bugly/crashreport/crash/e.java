...
public final class e implements Thread.UncaughtExceptionHandler {
    ...
    private CrashDetailBean b(Thread thread, Throwable th, boolean z, String str, byte[] bArr) {
        ...
        if (th2 == null || th2 == th) {
            ...
            sb.append(name).append(":").append(b2).append(DoCmdUtil.COMMAND_LINE_END);
            sb.append(str3);
            sb.append("\n......");
            sb.append("\nCaused by:\n");
            sb.append(crashDetailBean.n).append(":").append(crashDetailBean.o).append(DoCmdUtil.COMMAND_LINE_END);
            a2 = a(th2, c.f);
            sb.append(a2);
