...
public class z {
    ...
    public static byte[] a(File r8, String r9, String r10) {
        /*
            r0 = 0
            r7 = 0
        ...
        L_0x0043:
            r1 = move-exception
        L_0x0044:
            boolean r3 = com.tencent.bugly.proguard.x.a(r1)     // Catch:{ all -> 0x0091 }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static boolean a(File r6, File r7, int r8) {
        /*
            r3 = 0
            r0 = 0
            java.lang.String r1 = "rqdp{  ZF start}"
        ...
        L_0x008f:
            ...
            r3 = r4
        L_0x0091:
            boolean r4 = com.tencent.bugly.proguard.x.a(r1)     // Catch:{ all -> 0x0106 }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:20:0x0081 A[Catch:{ all -> 0x00e5 }] */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:52:0x00cd A[SYNTHETIC, Splitter:B:52:0x00cd] */
    /* JADX WARNING: Removed duplicated region for block: B:55:0x00d2 A[SYNTHETIC, Splitter:B:55:0x00d2] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static ArrayList<String> c(Context r6, String r7) {
        /*
            r1 = 1
            r3 = 0
            r2 = 0
        ...
        L_0x0019:
            ...
            java.io.File r3 = new java.io.File     // Catch:{ Throwable -> 0x00e9, all -> 0x00c9 }
            r3.<init>(r0)     // Catch:{ Throwable -> 0x00e9, all -> 0x00c9 }
            boolean r3 = r3.exists()     // Catch:{ Throwable -> 0x00e9, all -> 0x00c9 }
            if (r3 == 0) goto L_0x0036
            java.io.File r3 = new java.io.File     // Catch:{ Throwable -> 0x00e9, all -> 0x00c9 }
            r3.<init>(r0)     // Catch:{ Throwable -> 0x00e9, all -> 0x00c9 }
            boolean r3 = r3.canExecute()     // Catch:{ Throwable -> 0x00e9, all -> 0x00c9 }
            if (r3 != 0) goto L_0x0038
        L_0x0036:
            java.lang.String r0 = "sh"
        L_0x0038:
            java.util.ArrayList r3 = new java.util.ArrayList     // Catch:{ Throwable -> 0x00e9, all -> 0x00c9 }
            r4 = 2
            java.lang.String[] r4 = new java.lang.String[r4]     // Catch:{ Throwable -> 0x00e9, all -> 0x00c9 }
            r5 = 0
            r4[r5] = r0     // Catch:{ Throwable -> 0x00e9, all -> 0x00c9 }
            r0 = 1
            java.lang.String r5 = "-c"
            r4[r0] = r5     // Catch:{ Throwable -> 0x00e9, all -> 0x00c9 }
            java.util.List r0 = java.util.Arrays.asList(r4)     // Catch:{ Throwable -> 0x00e9, all -> 0x00c9 }
            r3.<init>(r0)     // Catch:{ Throwable -> 0x00e9, all -> 0x00c9 }
            r3.add(r7)     // Catch:{ Throwable -> 0x00e9, all -> 0x00c9 }
            java.lang.Runtime r4 = java.lang.Runtime.getRuntime()     // Catch:{ Throwable -> 0x00e9, all -> 0x00c9 }
            r0 = 3
            java.lang.String[] r0 = new java.lang.String[r0]     // Catch:{ Throwable -> 0x00e9, all -> 0x00c9 }
            java.lang.Object[] r0 = r3.toArray(r0)     // Catch:{ Throwable -> 0x00e9, all -> 0x00c9 }
            java.lang.String[] r0 = (java.lang.String[]) r0     // Catch:{ Throwable -> 0x00e9, all -> 0x00c9 }
            java.lang.Process r0 = r4.exec(r0)     // Catch:{ Throwable -> 0x00e9, all -> 0x00c9 }
            java.io.BufferedReader r4 = new java.io.BufferedReader     // Catch:{ Throwable -> 0x00e9, all -> 0x00c9 }
            java.io.InputStreamReader r3 = new java.io.InputStreamReader     // Catch:{ Throwable -> 0x00e9, all -> 0x00c9 }
            java.io.InputStream r5 = r0.getInputStream()     // Catch:{ Throwable -> 0x00e9, all -> 0x00c9 }
            r3.<init>(r5)     // Catch:{ Throwable -> 0x00e9, all -> 0x00c9 }
            r4.<init>(r3)     // Catch:{ Throwable -> 0x00e9, all -> 0x00c9 }
        L_0x006e:
            java.lang.String r3 = r4.readLine()     // Catch:{ Throwable -> 0x0078, all -> 0x00e0 }
            if (r3 == 0) goto L_0x0090
            r1.add(r3)     // Catch:{ Throwable -> 0x0078, all -> 0x00e0 }
            goto L_0x006e
        L_0x0078:
            r0 = move-exception
            r1 = r2
            r3 = r4
        L_0x007b:
            boolean r4 = com.tencent.bugly.proguard.x.a(r0)     // Catch:{ all -> 0x00e5 }
        ...
        L_0x008e:
            ...
            goto L_0x0018
        L_0x0090:
            java.io.BufferedReader r3 = new java.io.BufferedReader     // Catch:{ Throwable -> 0x0078, all -> 0x00e0 }
            java.io.InputStreamReader r5 = new java.io.InputStreamReader     // Catch:{ Throwable -> 0x0078, all -> 0x00e0 }
            java.io.InputStream r0 = r0.getErrorStream()     // Catch:{ Throwable -> 0x0078, all -> 0x00e0 }
            r5.<init>(r0)     // Catch:{ Throwable -> 0x0078, all -> 0x00e0 }
            r3.<init>(r5)     // Catch:{ Throwable -> 0x0078, all -> 0x00e0 }
        L_0x009e:
            java.lang.String r0 = r3.readLine()     // Catch:{ Throwable -> 0x00a8, all -> 0x00e2 }
            if (r0 == 0) goto L_0x00ac
            r1.add(r0)     // Catch:{ Throwable -> 0x00a8, all -> 0x00e2 }
            goto L_0x009e
        L_0x00a8:
            r0 = move-exception
            r1 = r3
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static Context a(Context r1) {
        /*
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static String a(Context r7, int r8, String r9) {
        /*
            r6 = 4
            r5 = 3
            r4 = 2
        ...
        for (Map.Entry next : allStackTraces.entrySet()) {
            ...
            if (!(next.getValue() == null || ((StackTraceElement[]) next.getValue()).length == 0)) {
                ...
                while (true) {
                    ...
                    sb.append(stackTraceElement.toString()).append(DoCmdUtil.COMMAND_LINE_END);
                    i2++;
                }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static String a(File r6, int r7, boolean r8) {
        /*
            r0 = 0
        ...
        L_0x005d:
            r1 = move-exception
        L_0x005e:
            com.tencent.bugly.proguard.x.a(r1)     // Catch:{ all -> 0x007a }
