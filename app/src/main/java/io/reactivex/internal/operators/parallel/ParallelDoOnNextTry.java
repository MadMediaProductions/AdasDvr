...
public final class ParallelDoOnNextTry<T> extends ParallelFlowable<T> {
    ...
    static final class ParallelDoOnNextSubscriber<T> implements ConditionalSubscriber<T>, Subscription {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:3:0x0009 A[LOOP:0: B:3:0x0009->B:11:0x0036, LOOP_START, PHI: r4 
          PHI: (r4v1 'retries' long) = (r4v0 'retries' long), (r4v2 'retries' long) binds: [B:2:0x0007, B:11:0x0036] A[DONT_GENERATE, DONT_INLINE], SYNTHETIC, Splitter:B:3:0x0009] */
        ...
        public boolean tryOnNext(T r11) {
            ...
            L_0x0015:
                ...
                io.reactivex.functions.BiFunction<? super java.lang.Long, ? super java.lang.Throwable, io.reactivex.parallel.ParallelFailureHandling> r7 = r10.errorHandler     // Catch:{ Throwable -> 0x0040 }
                r8 = 1
                long r4 = r4 + r8
                java.lang.Long r8 = java.lang.Long.valueOf(r4)     // Catch:{ Throwable -> 0x0040 }
                java.lang.Object r7 = r7.apply(r8, r0)     // Catch:{ Throwable -> 0x0040 }
                java.lang.String r8 = "The errorHandler returned a null item"
                java.lang.Object r2 = io.reactivex.internal.functions.ObjectHelper.requireNonNull(r7, r8)     // Catch:{ Throwable -> 0x0040 }
    ...
    static final class ParallelDoOnNextConditionalSubscriber<T> implements ConditionalSubscriber<T>, Subscription {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:3:0x0008 A[LOOP:0: B:3:0x0008->B:11:0x0035, LOOP_START, PHI: r4 
          PHI: (r4v1 'retries' long) = (r4v0 'retries' long), (r4v2 'retries' long) binds: [B:2:0x0006, B:11:0x0035] A[DONT_GENERATE, DONT_INLINE], SYNTHETIC, Splitter:B:3:0x0008] */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public boolean tryOnNext(T r11) {
            /*
                r10 = this;
            ...
            L_0x0014:
                r0 = move-exception
                io.reactivex.exceptions.Exceptions.throwIfFatal(r0)
                io.reactivex.functions.BiFunction<? super java.lang.Long, ? super java.lang.Throwable, io.reactivex.parallel.ParallelFailureHandling> r6 = r10.errorHandler     // Catch:{ Throwable -> 0x003f }
                r8 = 1
                long r4 = r4 + r8
                java.lang.Long r7 = java.lang.Long.valueOf(r4)     // Catch:{ Throwable -> 0x003f }
                java.lang.Object r6 = r6.apply(r7, r0)     // Catch:{ Throwable -> 0x003f }
                java.lang.String r7 = "The errorHandler returned a null item"
                java.lang.Object r2 = io.reactivex.internal.functions.ObjectHelper.requireNonNull(r6, r7)     // Catch:{ Throwable -> 0x003f }
                io.reactivex.parallel.ParallelFailureHandling r2 = (io.reactivex.parallel.ParallelFailureHandling) r2     // Catch:{ Throwable -> 0x003f }
