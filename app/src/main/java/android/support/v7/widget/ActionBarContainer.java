...
public class ActionBarContainer extends FrameLayout {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.mActionBarView != null) {
            ...
            if (this.mTabContainer != null && this.mTabContainer.getVisibility() != 8 && mode != 1073741824) {
                ...
                setMeasuredDimension(getMeasuredWidth(), Math.min(getMeasuredHeightWithMargins(this.mTabContainer) + topMarginForTabs, mode == Integer.MIN_VALUE ? MeasureSpec.getSize(heightMeasureSpec) : ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED));
            }
        }
    }
    ...
    public void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (!(tabContainer == null || tabContainer.getVisibility() == 8)) {
            ...
            LayoutParams lp = (LayoutParams) tabContainer.getLayoutParams();
