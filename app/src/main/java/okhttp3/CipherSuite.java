...
public final class CipherSuite {
    ...
    public static final CipherSuite TLS_DHE_DSS_WITH_CAMELLIA_256_CBC_SHA = of("TLS_DHE_DSS_WITH_CAMELLIA_256_CBC_SHA", Imgproc.COLOR_COLORCVT_MAX);
    ...
    public static final CipherSuite TLS_RSA_WITH_CAMELLIA_256_CBC_SHA = of("TLS_RSA_WITH_CAMELLIA_256_CBC_SHA", Imgproc.COLOR_BGR2YUV_YV12);
