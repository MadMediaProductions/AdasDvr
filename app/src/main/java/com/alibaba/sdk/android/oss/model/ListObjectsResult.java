...
public class ListObjectsResult extends OSSResult {
    ...
    public void setObjectSummaries(List<OSSObjectSummary> objectSummaries2) {
        this.objectSummaries.clear();
        if (objectSummaries2 != null && !objectSummaries2.isEmpty()) {
            this.objectSummaries.addAll(objectSummaries2);
        }
    }
