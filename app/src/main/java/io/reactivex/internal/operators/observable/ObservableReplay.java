...
public final class ObservableReplay<T> extends ConnectableObservable<T> implements HasUpstreamObservableSource<T>, Disposable {
    ...
    static final class ReplaySource<T> implements ObservableSource<T> {
        ...
        public void subscribe(Observer<? super T> r7) {
            /*
                r6 = this;
            L_0x0000:
    ...
    static final class MulticastReplay<R, U> extends Observable<R> {
        ...
        public void subscribeActual(Observer<? super R> child) {
            try {
                ConnectableObservable<U> co = (ConnectableObservable) this.connectableFactory.call();
                ObservableSource<R> observable = (ObservableSource) this.selector.apply(co);
