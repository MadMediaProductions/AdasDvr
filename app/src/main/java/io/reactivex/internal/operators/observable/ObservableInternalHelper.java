...
public final class ObservableInternalHelper {
    ...
    public static <T, R> Observable<R> switchMapSingle(Observable<T> r2, Function<? super T, ? extends SingleSource<? extends R>> r3) {
        /*
    ...
    /* JADX WARNING: Unknown variable types count: 1 */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static <T, R> Observable<R> switchMapSingleDelayError(Observable<T> r2, Function<? super T, ? extends SingleSource<? extends R>> r3) {
        /*
            io.reactivex.functions.Function r0 = convertSingleMapperToObservableMapper(r3)
            r1 = 1
    ...
    static final class ReplayFunction<T, R> implements Function<Observable<T>, ObservableSource<R>> {
        ...
        public ObservableSource<R> apply(Observable<T> t) throws Exception {
            return Observable.wrap((ObservableSource) this.selector.apply(t)).observeOn(this.scheduler);
        }
    }
}
