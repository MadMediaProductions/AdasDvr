...
public class Imgproc {
    ...
    private static native void HoughLines_0(long j, long j2, double d, double d2, int i, double d3, double d4);

    private static native void HoughLines_1(long j, long j2, double d, double d2, int i);

    private static native void HuMoments_0(long j, long j2);
    ...
    private static native void adaptiveBilateralFilter_0(long j, long j2, double d, double d2, double d3, double d4, double d5, double d6, int i);

    private static native void adaptiveBilateralFilter_1(long j, long j2, double d, double d2, double d3, double d4, double d5, double d6);

    private static native void adaptiveBilateralFilter_2(long j, long j2, double d, double d2, double d3);
    ...
    private static native void distanceTransform_0(long j, long j2, int i, int i2);
    ...
    private static native void integral2_0(long j, long j2, long j3, int i);

    private static native void integral2_1(long j, long j2, long j3);

    private static native void integral3_0(long j, long j2, long j3, long j4, int i);
    ...
    private static native void matchTemplate_0(long j, long j2, long j3, int i);
    ...
    private static native long moments_0(long j, boolean z);

    private static native long moments_1(long j);
    ...
    private static native double[] phaseCorrelateRes_0(long j, long j2, long j3, double[] dArr);

    private static native double[] phaseCorrelateRes_1(long j, long j2, long j3);

    private static native double[] phaseCorrelate_0(long j, long j2, long j3);
    ...
    public static void drawContours(Mat image, List<MatOfPoint> contours, int contourIdx, Scalar color, int thickness, int lineType, Mat hierarchy, int maxLevel, Point offset) {
        drawContours_0(image.nativeObj, Converters.vector_vector_Point_to_Mat(contours, new ArrayList(contours != null ? contours.size() : 0)).nativeObj, contourIdx, color.val[0], color.val[1], color.val[2], color.val[3], thickness, lineType, hierarchy.nativeObj, maxLevel, offset.x, offset.y);
    }
    ...
    public static Point phaseCorrelate(Mat src1, Mat src2, Mat window) {
        return new Point(phaseCorrelate_0(src1.nativeObj, src2.nativeObj, window.nativeObj));
    }
    ...
    public static Point phaseCorrelateRes(Mat src1, Mat src2, Mat window) {
        return new Point(phaseCorrelateRes_1(src1.nativeObj, src2.nativeObj, window.nativeObj));
    }
