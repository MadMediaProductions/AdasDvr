    ...
    public final void handleNativeException2(int i, int i2, long j, long j2, String str, String str2, String str3, String str4, int i3, String str5, int i4, int i5, int i6, String str6, String str7, String[] strArr) {
        ...
        try {
            ...
            if (this.d.c().g || !this.d.b()) {
                ...
                b.a("NATIVE_CRASH", z.a(), str10, str11, str9 + DoCmdUtil.COMMAND_LINE_END + str2 + DoCmdUtil.COMMAND_LINE_END + a2, packageCrashDatas);
            ...
            b.a("NATIVE_CRASH", z.a(), str10, str11, str9 + DoCmdUtil.COMMAND_LINE_END + str2 + DoCmdUtil.COMMAND_LINE_END + a2, (CrashDetailBean) null);
            z.b(str4);
        } catch (Throwable th) {
            if (!x.a(th)) {
                th.printStackTrace();
